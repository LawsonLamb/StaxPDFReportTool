...
public class Main extends Application {
    ...
    private  void FXSceneInit(Stage primaryStage) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("PDFReportToolScene.fxml"));
    ...
    private void PDFCanvasTest(Stage primaryStage) throws IOException {
        ...
        PDDocument doc = PDDocument.load(new File("LGS_Business_Personal_Property_Tax_Return_PT50P.pdf"));
    ...
    private  void ICE_TEST(Stage primaryStage) throws IOException {
        ...
        pane = new Pane();
        PDDocument doc = PDDocument.load(new File("LGS_Business_Personal_Property_Tax_Return_PT50P.pdf"));
        ICEPDFCanvas icepdfCanvas = new ICEPDFCanvas("LGS_Business_Personal_Property_Tax_Return_PT50P.pdf");
